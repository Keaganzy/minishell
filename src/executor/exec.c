...
/*   Updated: 2025/11/18 17:34:37 by ksng             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	execute_node(t_ast *node, t_shell *shell);
static int	execute_cmd(t_ast *node, t_shell *shell);
static int	execute_pipe(t_ast *node, t_shell *shell);
static int	execute_redir(t_ast *node, t_shell *shell);
static int	execute_logical(t_ast *node, t_shell *shell);
