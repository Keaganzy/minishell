...
/*   Updated: 2025/10/19 18:14:59 by jotong           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 				if (tmp->next->type == T_SPACE)		// TODO: this part needs to be fixed, T_SPACE should not be converted to N_SPACE node in AST
// 				{
// 					if (i > 1)
// 					{
// 						curr->argv[i] = malloc(2 * sizeof(char));
// 						curr->argv[i][0] = ' ';
// 						curr->argv[i][1] = '\0';
// 						i++;
// 					}
...
// 			size = 0;
// 		}
// 		else if (tokens->type == T_SPACE && i > 0)
// 		{
// 			if (i > 0)
// 			{
