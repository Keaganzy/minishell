...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2025/09/11 23:09:18 by jotong            #+#    #+#              #
#    Updated: 2025/10/07 23:43:09 by jotong           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSER_FILES	= $(SRC_DIR)/$(PARSER_DIR)/parser_utils.c $(SRC_DIR)/$(PARSER_DIR)/parser.c
